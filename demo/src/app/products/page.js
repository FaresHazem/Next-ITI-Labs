  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="fw-bold text-dark mb-0">Products Catalog (DEMO 1)</h2>
      ...
      <div className="card shadow-sm border p-3 mb-4 bg-light">
        <div className="row g-2">
          ...
          <div className="col-md-3">
            <select
              className="form-select border text-capitalize"
              value={categoryInput}
                    ...
                    <div className="card-body d-flex flex-column p-3">
                      ...
                      <div className="d-flex justify-content-between align-items-center mt-auto">
                        ...
                        <div className="d-flex gap-1">
                          <Link href={`/products/${p._id}`} className="btn btn-dark btn-xs rounded-pill px-3 py-1 fw-semibold small" style={{ fontSize: '0.8rem' }}>
                            Details
                          </Link>
